		...
		<div id="loginForm">
			<el-form ref="loginObj" :rules="logonRules" :model="loginObj" label-width="80px" style="width:80%;">
				<el-form-item label="用户名" prop="name">
					<el-input type="username" v-model="loginObj.name" placeholder="请输入用户名" prefix-icon="el-icon-edit"></el-input>
				</el-form-item>
				<el-form-item label="密码" prop="pass">
					<el-input type="password" v-model="loginObj.pass" placeholder="请输入密码" prefix-icon="el-icon-edit"></el-input>
				</el-form-item>
				<el-form-item>
